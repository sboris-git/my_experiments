...
path.name.ext <- "/home/boris/Dropbox/Students/Стельмащук/Stelmashchuk@student/UJ my measurements/Analysis/CSVa/PCA_IVi.csv"
...
ir.species <- factor(CV.dat[, 4]) # extract and store names in variable
# factor(CV.dat[, 2] = dE_dt
...
# plot method
plot(ir.pca, type = "l") # summary method
summary(ir.pca)
...
arrow_style <- arrow(length = unit(0.05, "inches"),
                     type = "closed")
# theme_bw()
g <- ggbiplot(ir.pca, choices = 2:3, obs.scale = 1, var.scale = 1, 
              groups = ir.species, ellipse = TRUE, circle = TRUE, circle.prob = 0.95, 
              varname.size = 4, labels=ir.species)
# http://www.rdocumentation.org/packages/ggbiplot/functions/ggbiplot
...
print(g)
ggsave(filename = "PCA-I-VIII-labels-Glu-PC_23.png", plot = g, width = 6, height = 7)
